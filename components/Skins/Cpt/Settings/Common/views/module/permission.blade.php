                ...
                <div class="panel">
                    <div class="panel-heading">
                        <div class="pull-left">
                            ...
                            <small><a href="{{$cptUrlHandler->managerUrl('global.permission')}}" target="_blank">{{xe_trans('xe::moveToParentSettingPage')}}</a></small>
                        </div>
                    </div>
                    <form method="post" id="board_manage_form" action="{!! $cptUrlHandler->managerUrl('permission.update', ['instanceId' => $instanceId]) !!}">
