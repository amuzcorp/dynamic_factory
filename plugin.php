...
//                ]);
    ...
    protected function registerSettingsRoute()
    {
        Route::group([
            ...
            Route::get('/child/taxonomies', ['as' => 'child.taxonomies', 'uses' => 'DynamicFactoryController@getChildTaxonomies']);
        ...
        Route::settings(static::getId(), function() {
            Route::group([
                ...
                Route::get('/edit_alarm/{cpt_id}', [ 'as' => 'edit_alarm', 'uses' => 'DynamicFactorySettingController@editAlarm' ]);
                Route::post('/update_alarm/{cpt_id}', [ 'as' => 'update_alarm', 'uses' => 'DynamicFactorySettingController@updateAlarm' ]);
                ...
                Route::post('/remove_all_cpt_documents', ['as' => 'remove_all_cpt_documents', 'uses' => 'DynamicFactorySettingController@removeAllDocuments']);
