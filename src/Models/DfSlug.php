...
class DfSlug extends DynamicModel
{
    static protected $reserved = [];

    protected $table = 'df_slug';
    ...
    /**
     * 예약어 추가
     * * CPT Document Routing 에 사용하는 이름은 슬러그로 사용할 수 없음
     *
     ...
     */
    public function cptDocument()
    {
        return $this->hasOne(CptDocument::class, 'id', 'target_id');
    }
}
